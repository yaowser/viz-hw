/*
 ...
 Features:
 4 turrets: aoe, laser, rocket launcher, sniper
 4 enemies: basic, EnemyRay, EnemySpider, boss
 Money System
 Can upgrade turrets
 ...
 3.EnemyBlockies - class for the basic enemy
 4.EnemyKinArt - class for the boss enemy
 EnemyRay - class for EnemyRay enemy
 EnemySpider - class for EnemySpider enemy
 ...
 6.cannon - class for laser cannon turret
 15.rocket - class to the the launcher turret
 2.AOE - class for the pulser turret with aoe damage
 17.sniper - class to hold the sniper turret
 18.turret - abstract super class for all turrets
